...
// AI Features - Bangladesh Law AI Tools
Route::get('/ai-features', [AiFeaturesController::class, 'index'])->name('ai.features');
Route::post('/ai/dhara', [AiFeaturesController::class, 'getDhara'])->name('ai.dhara');
Route::post('/ai/legal-term', [AiFeaturesController::class, 'getLegalTerm'])->name('ai.legal-term');
Route::post('/ai/analyze-document', [AiFeaturesController::class, 'analyzeDocument'])->name('ai.analyze-document');
Route::post('/ai/predict-case', [AiFeaturesController::class, 'predictCase'])->name('ai.predict-case');
Route::post('/ai/procedure', [AiFeaturesController::class, 'getProcedure'])->name('ai.procedure');
...
Route::post('/ai/inheritance', [AiFeaturesController::class, 'calculateInheritance'])->name('ai.inheritance');
Route::post('/ai/case-timeline', [AiFeaturesController::class, 'buildCaseTimeline'])->name('ai.case-timeline');
