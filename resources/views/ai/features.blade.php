                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <div class="feature-card" data-tool="inheritance" onclick="selectTool('inheritance')">
                            ...
                            <h6 class="fw-bold mb-1">{{ __('messages.tool_inheritance') ?? 'Inheritance Calculator' }}</h6>
                            <small class="text-muted">{{ __('messages.tool_inheritance_desc') ?? 'Islamic/Hindu Shares' }}</small>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="feature-card" data-tool="timeline" onclick="selectTool('timeline')">
                            ...
                            <small class="text-muted">{{ __('messages.tool_timeline_desc') ?? 'Build Legal Timeline' }}</small>
                        </div>
                    </div>
                </div>
            </div>
