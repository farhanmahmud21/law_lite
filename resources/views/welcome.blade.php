...
@push('scripts')
    <script>
        document.getElementById('aiQuestionForm').addEventListener('submit', async function(e) {
            ...
            responseAlert.innerHTML = '<div class="d-flex align-items-center"><div class="spinner-grow spinner-grow-sm me-2" style="color: var(--accent);"></div>{{ __('messages.analyzing_question') }}</div>';
            ...
            try {
                ...
                if (response.ok && data.ok) {
                    ...
                    responseAlert.innerHTML =
                        '<div class="d-flex align-items-center mb-2"><i class="bi bi-check-circle-fill me-2" style="color: var(--accent);"></i><strong>{{ __('messages.ai_response_label') }}</strong></div><div style="white-space: pre-wrap;" class="mt-2">' +
                        answer + '</div>';
                } else {
                ...
                responseAlert.className = 'alert alert-danger border-0 shadow-sm';
                responseAlert.style.borderLeft = '4px solid #ef4444';
                responseAlert.innerHTML = '<i class="bi bi-wifi-off me-2"></i>{{ __('messages.network_error') }}';
            } finally {
