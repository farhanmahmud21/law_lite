            ...
            <div class="col-md-4 col-lg-3 border-end d-flex flex-column bg-light h-100" id="conversation-sidebar">
                <div class="p-3 border-bottom bg-white d-flex justify-content-between align-items-center flex-shrink-0 shadow-sm">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        ?>
                        <span id="total-unread-badge" class="badge bg-danger rounded-pill <?php echo e($totalUnread > 0 ? '' : 'd-none'); ?>" style="min-width: 24px; height: 24px; display: flex; align-items: center; justify-content: center;">
                ...
                <div class="p-3 bg-light flex-shrink-0">
                    <div class="position-relative">
                        ...
                        <input type="text" class="form-control form-control-sm ps-5" placeholder="<?php echo e(__('messages.search')); ?>..."
                ...
                <div id="conversation-search-empty" class="text-center text-muted small py-2 d-none">
                    <?php echo e(__('messages.no_conversations')); ?>
                ...
                <div class="list-group list-group-flush overflow-auto flex-grow-1" id="conversation-list">
                    <?php $__empty_1 = true; $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0 py-3 conversation-item conversation-link"
                            ...
                            data-user-name="<?php echo e($partner->name); ?>">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3 flex-grow-1 overflow-hidden">
                                    <div class="d-flex justify-content-between align-items-baseline">
                                        <h6 class="mb-0 text-truncate fw-semibold"><?php echo e($partner->name); ?></h6>
                                    ...
                                    <p class="mb-0 text-muted text-truncate small conversation-preview">
                                        ...
                                        <?php endif; ?>
                                        <?php echo e($lastMsg ? \Illuminate\Support\Str::limit($lastMsg->content, 40) : __('messages.no_messages')); ?>
                ...
                <div id="chat-interface" class="d-none flex-column h-100">
                    ...
                    <div class="p-3 border-bottom bg-white d-flex align-items-center shadow-sm flex-shrink-0" style="z-index: 1;">
                        ...
                        <div class="ms-auto d-flex gap-2">
                            <button class="btn btn-light btn-sm rounded-circle shadow-sm" title="<?php echo e(__('messages.audio_call')); ?>"
                            ...
                            <div class="d-flex align-items-center w-100" style="gap: 8px;">
                                ...
                                <div class="flex-grow-1" style="position: relative;">
                                    <input type="text" id="chat-input" class="form-control border-0 shadow-none text-body chat-input-modern"
                                        placeholder="<?php echo e(__('messages.type_message')); ?>..." style="border-radius: 24px; padding: 12px 20px; background: #f8f9fa; border: 2px solid #e5e7eb !important; transition: all 0.3s ease;">
                                </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\CG\LawLite\resources\views/chat/inbox.blade.php ENDPATH**/ ?>