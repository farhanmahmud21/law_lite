            ...
            <div class="col-lg-4">
                <div class="profile-card sticky-top reveal" style="top: 100px; z-index: 1;">
                    <div class="card-body text-center p-5">
                        <div class="profile-photo d-inline-block mb-4">
                            <?php if($lawyer->user->profile_photo_path): ?>
                                <img src="<?php echo e(asset('storage/' . $lawyer->user->profile_photo_path)); ?>"
                                    alt="<?php echo e($lawyer->user->name); ?>" class="rounded-circle"
                        ...
                        <h3 class="fw-bold mb-2"><?php echo e($lawyer->user->name ?? 'Lawyer'); ?></h3>
                        <div class="expertise-badge mb-3"><?php echo e($lawyer->expertise ?? __('messages.general_practice')); ?></div>
                        ...
                        <div class="d-grid gap-3">
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('messages.inbox')); ?>" class="btn btn-primary action-btn-primary">
                                    <i class="bi bi-chat-dots-fill me-2"></i><?php echo e(__('messages.message')); ?>

                                </a>
                                <button class="btn action-btn-outline" data-bs-toggle="modal"
                                    data-bs-target="#appointmentModal" data-lawyer-id="<?php echo e($lawyer->id); ?>"
                                    data-hourly-rate="<?php echo e($lawyer->hourly_rate ?? 500); ?>"
                                    data-lawyer-name="<?php echo e($lawyer->user->name ?? 'Lawyer'); ?>">
                                    <i class="bi bi-calendar-check me-2"></i><?php echo e(__('messages.book_appointment')); ?>

                                </button>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-primary action-btn-primary">
                                    <?php echo e(__('messages.sign_in_to_message')); ?>

                                </a>
                                <a href="<?php echo e(route('login')); ?>" class="btn action-btn-outline">
                                    <?php echo e(__('messages.sign_in_to_book')); ?>
            ...
            <div class="col-lg-8">
                ...
                <div class="detail-card mb-4 reveal">
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <p class="text-muted leading-relaxed mb-0"><?php echo e($lawyer->bio ?? 'No biography available.'); ?></p>
                    </div>
                </div>
                    ...
                    <div class="detail-card mb-4 reveal" style="animation-delay: 0.3s;">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <?php $__currentLoopData = $lawyer->languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="language-badge"><?php echo e($lang); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\CG\LawLite\resources\views/lawyers/show.blade.php ENDPATH**/ ?>