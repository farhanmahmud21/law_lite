<?php $__env->startSection('content'); ?>
    ...
    <div class="container py-5">
        ...
        <div class="articles-hero reveal text-center">
            <h1 class="display-5 fw-bold hero-title mb-3"><?php echo e(__('messages.articles')); ?></h1>
            <p class="text-muted lead mb-0"><?php echo e(__('messages.articles_subtitle')); ?></p>
        </div>
                    ...
                    <form method="GET" action="<?php echo e(route('articles.index')); ?>">
                        <div class="input-group">
                            ...
                            <?php if(request('search')): ?>
                                <a href="<?php echo e(route('articles.index')); ?>" class="btn btn-outline-secondary ms-2" style="border-radius: 12px;">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-lg-6 mb-4 reveal" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s;">
                    <div class="card article-card border-0 position-relative">
                        <div class="card-body">
                            <h5 class="article-title"><?php echo e($article->title); ?></h5>
                            <p class="article-excerpt"><?php echo e(\Illuminate\Support\Str::limit($article->content, 140)); ?></p>
                            <a href="<?php echo e(route('articles.show', $article->id)); ?>" class="read-btn text-decoration-none">
                                <?php echo e(__('messages.read')); ?> <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-12 reveal">
                    <div class="empty-state">
                        ...
                        <h4 class="fw-bold mb-2"><?php echo e(__('messages.no_articles')); ?></h4>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\CG\LawLite\resources\views/articles/index.blade.php ENDPATH**/ ?>