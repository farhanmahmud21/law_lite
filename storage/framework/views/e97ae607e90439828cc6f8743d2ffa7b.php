    ...
    <div class="container py-5">
        <div class="article-container">
            <div class="article-header reveal">
                <h1 class="article-title mb-4"><?php echo e($article->title); ?></h1>
                <span class="article-date">
                    <i class="bi bi-calendar3"></i>
                    Published: <?php echo e($article->created_at->format('M d, Y')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\CG\LawLite\resources\views/articles/show.blade.php ENDPATH**/ ?>