<?php $__env->startPush('styles'); ?>
    <style>
        ...
        @media (max-width: 991px) {
            ...
            .hero-section { padding: 7rem 0 5rem; min-height: auto; }
        }
        ...
        @keyframes card-morph {
            ...
            25% { border-radius: 24px 60px 24px 60px; }
            50% { border-radius: 60px 24px 60px 24px; }
            75% { border-radius: 24px 60px 24px 60px; }
        }
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 reveal reveal-left">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <span class="badge-modern d-inline-flex align-items-center">
                            <i class="bi bi-stars me-2"></i> <?php echo e(__('messages.hero_badge')); ?>
                    ...
                    <h1 class="hero-title mb-4">
                        ...
                        <span class="hero-gradient-text"><?php echo e(__('messages.hero_title_2')); ?></span>
                    </h1>
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 mb-5">
                        <?php if(auth()->guard()->guest()): ?>
                            <a href="<?php echo e(route('lawyers.index')); ?>"
                                ...
                                <span><i class="bi bi-search me-2"></i><?php echo e(__('messages.find_lawyer_btn')); ?></span>
                            </a>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-primary btn-lg px-5 py-3 fw-semibold">
                        ...
                        <?php else: ?>
                            ...
                            <?php if(Auth::user()->role === 'lawyer'): ?>
                                <a href="<?php echo e(route('lawyer.dashboard')); ?>" class="btn btn-dark btn-lg px-5 py-3 fw-semibold">
                                    <i class="bi bi-speedometer2 me-2"></i><?php echo e(__('messages.dashboard')); ?>

                                </a>
                            <?php elseif(Auth::user()->role === 'admin'): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-dark btn-lg px-5 py-3 fw-semibold">
                ...
                <div class="col-lg-5 offset-lg-1 reveal reveal-right">
                    <div class="ai-card p-4 p-md-5 tilt-effect">
                        ...
                        <form action="<?php echo e(route('ai.ask')); ?>" method="POST" id="aiQuestionForm">
                            ...
                            <div class="mb-3">
                                <textarea name="question" class="form-control p-3" rows="4"
                                    placeholder="<?php echo e(__('messages.ai_input_placeholder')); ?>" style="resize: none; background: #f8fafc;" required></textarea>
                            </div>
                        ...
                        <div class="d-flex justify-content-center gap-4 mt-4 pt-2">
                            <a href="<?php echo e(route('ai.features')); ?>" class="text-decoration-none d-flex align-items-center gap-2 text-muted hover-underline icon-bounce" style="font-size: 0.875rem;">
            ...
            <div class="row g-0">
                <div class="col-md-4 reveal stagger-1">
                    <div class="stat-card">
                        ...
                        <div class="stat-label"><?php echo e(__('messages.stat_secure_platform')); ?></div>
                    </div>
                </div>
                <div class="col-md-4 reveal stagger-2">
                    <div class="stat-card">
                        <div class="stat-number counter" data-target="98">0</div>
                        <div class="stat-label"><?php echo e(__('messages.stat_client_satisfaction')); ?></div>
                    </div>
                </div>
                <div class="col-md-4 reveal stagger-3">
                    <div class="stat-card">
                        <div class="stat-number">24/7</div>
                        <div class="stat-label"><?php echo e(__('messages.stat_ai_support')); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1 reveal reveal-right">
                    ...
                    <div class="d-flex mb-4 p-4 rounded-4 hover-lift glow-border" style="background: linear-gradient(135deg, #f8fafc 0%, #fff 100%); border-radius: 20px;">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1"><?php echo e(__('messages.step_1_title')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(__('messages.step_1_desc')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex mb-4 p-4 rounded-4 hover-lift glow-border" style="background: linear-gradient(135deg, #f8fafc 0%, #fff 100%); border-radius: 20px;">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1"><?php echo e(__('messages.step_2_title')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(__('messages.step_2_desc')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex p-4 rounded-4 hover-lift glow-border" style="background: linear-gradient(135deg, #f8fafc 0%, #fff 100%); border-radius: 20px;">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1"><?php echo e(__('messages.step_3_title')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(__('messages.step_3_desc')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('register')); ?>"
                        ...
                        <i class="bi bi-arrow-right-circle me-2"></i><?php echo e(__('messages.cta_btn_guest')); ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('lawyers.index')); ?>"
                        class="btn btn-accent btn-lg px-5 py-3 fw-bold btn-magnetic ripple" style="font-size: 1.1rem;">
                        <i class="bi bi-search me-2"></i><?php echo e(__('messages.cta_btn_user')); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        document.getElementById('aiQuestionForm').addEventListener('submit', async function(e) {
            ...
            responseAlert.innerHTML = '<div class="d-flex align-items-center"><div class="spinner-grow spinner-grow-sm me-2" style="color: var(--accent);"></div><?php echo e(__('messages.analyzing_question')); ?></div>';
            ...
            try {
                ...
                if (response.ok && data.ok) {
                    ...
                    responseAlert.innerHTML =
                        '<div class="d-flex align-items-center mb-2"><i class="bi bi-check-circle-fill me-2" style="color: var(--accent);"></i><strong><?php echo e(__('messages.ai_response_label')); ?></strong></div><div style="white-space: pre-wrap;" class="mt-2">' +
                        answer + '</div>';
                } else {
                    responseAlert.className = 'alert alert-danger border-0 shadow-sm';
                    responseAlert.style.borderLeft = '4px solid #ef4444';
                    responseAlert.innerHTML = '<i class="bi bi-exclamation-triangle-fill me-2"></i>' + (data.error || data.message ||
                        '<?php echo e(__('messages.error_occurred')); ?>');
                }
            } catch (error) {
                responseAlert.className = 'alert alert-danger border-0 shadow-sm';
                responseAlert.style.borderLeft = '4px solid #ef4444';
                responseAlert.innerHTML = '<i class="bi bi-wifi-off me-2"></i><?php echo e(__('messages.network_error')); ?>';
            } finally {
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\CG\LawLite\resources\views/welcome.blade.php ENDPATH**/ ?>