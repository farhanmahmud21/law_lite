                    ...
                    <div class="auth-card">
                        ...
                        <form method="POST" action="<?php echo e(route('login.post')); ?>">
                            ...
                            <?php if(session('status')): ?>
                                <div class="alert alert-success rounded-3 mb-3 py-2 px-3" style="font-size: 0.875rem;"><?php echo e(session('status')); ?></div>
                            <?php endif; ?>
                            
                            <div class="mb-3">
                                <label class="form-label"><?php echo e(__('messages.email')); ?></label>
                                <input name="email" type="email" value="<?php echo e(old('email')); ?>" class="form-control auth-input" placeholder="name@example.com" />
                            </div>
                            <div class="mb-4">
                            ...
                            <button class="btn btn-primary auth-btn">
                                <i class="bi bi-box-arrow-in-right me-2"></i><?php echo e(__('messages.login')); ?>
                            ...
                            <?php if(env('APP_ENV') === 'local'): ?>
                                <div class="dev-section">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="<?php echo e(url('/_dev/login-as/admin')); ?>" class="dev-btn text-decoration-none">
                                            <i class="bi bi-shield-check me-1"></i>Admin
                                        </a>
                                        <a href="<?php echo e(url('/_dev/login-as/lawyer')); ?>" class="dev-btn text-decoration-none">
                                            <i class="bi bi-briefcase me-1"></i>Lawyer
                                        </a>
                                        <a href="<?php echo e(url('/_dev/login-as/user')); ?>" class="dev-btn text-decoration-none">
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\CG\LawLite\resources\views/auth/login.blade.php ENDPATH**/ ?>